    ...
    ***************************************************************************** */
    ...
    function boxAnimations() {
        return animations.trigger('boxAnimations', [
            // in
            animations.transition('* => bounceIn', animations.animate('600ms cubic-bezier(0.215, 0.61, 0.355, 1)', animations.keyframes(bounceIn))),
    ...
    var ConfirmBoxWrapperComponent = /** @class */ (function () {
        function ConfirmBoxWrapperComponent(confirmBoxBelonging, cd) {
            ...
            this.boxAnimation = exports.AppearanceAnimation.NONE;
            setTimeout(function () {
