...
import { style, trigger, transition, animate, keyframes, state, query, animateChild } from '@angular/animations';
...
function boxAnimations() {
    return trigger('boxAnimations', [
        // in
        transition('* => bounceIn', animate('600ms cubic-bezier(0.215, 0.61, 0.355, 1)', keyframes(bounceIn))),
